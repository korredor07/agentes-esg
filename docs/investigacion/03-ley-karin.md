...
| **Ley 19.668** | 10-03-2000 (versión vigente: 06-01-2007, tras la Ley 20.148) | Artículo único, **texto vigente**: *"Trasládanse los feriados correspondientes al 29 de junio, día de San Pedro y San Pablo; 12 de octubre, día del descubrimiento de dos mundos; **a los días lunes de la semana en que ocurren, en caso de corresponder a día martes, miércoles o jueves, o los días lunes de la semana siguiente, en caso de corresponder a día viernes**."* (La referencia a Corpus Christi que tenía el texto original fue eliminada por la Ley 20.148.) | [VERIFICADO] [18] |
...
7. **Ley 18.700 art. 169**: citado por la DT; falta leerlo en BCN.
8. **Plataforma electrónica de denuncias de la DT** y **portal/modelo de protocolo oficial de la DT**: no se confirmaron URLs ni si están operativos.
9. **Periodicidad de reevaluación del riesgo psicosocial** (CEAL-SM) según el Compendio SUSESO: no se obtuvo un intervalo numérico.
10. **Contraloría**: el Dictamen N° E516610 de 19-07-2024 y su aclaración de 2025 no se verificaron en contraloria.cl.
11. **Tipo de día (hábil/corrido) de los plazos del sector público** (5 y 20 días): no determinado; probablemente días hábiles administrativos de la Ley 19.880, pero no se verificó.
12. **Fuente oficial del solsticio de invierno.** La Ley 21.357 declara feriado "el día del solsticio de invierno de cada año en el hemisferio sur" sin designar organismo ni método de determinación. Para el motor hay que fijar una fuente de efemérides astronómicas en hora oficial de Chile continental y documentarla; no se encontró decreto ni instructivo anual que la fije. [NO VERIFICADO]
13. **Feriados regionales adicionales** (por ejemplo, posibles feriados locales creados en 2025-2026) no fueron barridos exhaustivamente.
...
18. Biblioteca del Congreso Nacional de Chile — Ley Chile. **Ley 19.668, de 10-03-2000**, "Traslada a los días lunes los feriados que indica". https://www.bcn.cl/leychile/navegar?idNorma=160270 (versión vigente 06-01-2007) [OFICIAL — texto leído directamente]
...
23. Biblioteca del Congreso Nacional de Chile — Ley Chile. **Ley 21.357, de 19-06-2021** (Día Nacional de los Pueblos Indígenas, solsticio de invierno). https://www.bcn.cl/leychile/navegar?idNorma=1161743 [OFICIAL — texto leído directamente]
...
27. Biblioteca del Congreso Nacional de Chile — Ley Chile. **Código del Trabajo** (DFL N° 1, de 2002, del Ministerio del Trabajo y Previsión Social), texto vigente. Artículos 153, 505 bis, 506 y 506 ter leídos directamente. https://www.bcn.cl/leychile/navegar?idNorma=207436 [OFICIAL]
